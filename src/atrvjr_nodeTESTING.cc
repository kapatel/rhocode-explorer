...
//includes and using statement added from motor.cpp
#include "std_msgs/String.h"
#include <sstream>
#include <iostream>
using namespace std;

//variable for letter command (WILL NOT BE NEEDED WHEN WE GET RID OF THE COMMAND LINE PROMPTS)
char command;
int dist;
float ang;
...
int main(int argc, char** argv) {
    ...
    //ADDED CODE HERE
    //Ask user for velocity as input and then print back what the user enters
    cout << "Please enter a command letter: \nForward- f \nBackward- b\nLeft - l\nRight- r\nStop-s\n";
    cin >> command;
//	cout << "Enter the distance as an integer: ";
//	
//	cin >> dist;
    cout << "Enter an angular velocity";
    cin >> ang;
    ...
    //if we recive an s or any non-valid letter we exit
    else
     {
       msg.linear.x = 0;
       msg.angular.z = 0;
    ...
    //THIS IS WHERE THE CODE I ADDED ENDS
